        ...
        <NosotrosContainer id='nosotros'>
            <NosotrosWrapper>
                <NosotrosText ref={textRef} className={isVisible ? 'visible' : ''}>
                    <h3>¿quienes somos?</h3>
                    <p>En <span>GENTÍO</span>, transformamos ideas en conversaciones que impulsan tu crecimiento. Somos una agencia de comunicación y marketing digital dedicada a fortalecer tu marca con estrategias respaldadas por experiencias de éxito comprobadas. Nuestro objetivo: aumentar tu facturación y hacer que tu negocio se destaque</p>
