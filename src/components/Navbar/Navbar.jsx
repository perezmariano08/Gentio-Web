...
import { NavbarContainer, NavbarItem, NavbarList, NavbarLogoLink, NavbarWrapper, SvgLogo } from './NavbarStyles'
...
const Navbar = () => {
    ...
    return (
        ...
        <NavbarContainer className={scrollNav ? 'scrolled' : ''}>
            <NavbarWrapper>
                    <NavbarLogoLink to={`/${lang}`} onClick={onLogoClick}>
                    <SvgLogo 
                    initial="hidden"
                    animate="visible"
                    variants={logoVariants}
                    viewBox="0 0 343 117" fill="none" xmlns="http://www.w3.org/2000/svg">
