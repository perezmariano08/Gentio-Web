...
import { NavbarContainer, NavbarList, NavbarWrapper } from './NavbarStyles'
    ...
    return (
        <><NavbarContainer className={scrollNav ? 'scrolled' : ''}>
            <NavbarWrapper>
                ...
                <svg height="50%" viewBox="0 0 343 117" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <RiMenu3Fill className='icon-menu' onClick={toggleModalMenu} />
            </NavbarWrapper>
        </NavbarContainer>
