...
const Equipo = () => {
    ...
    const teamMembers = [
        ...
        { name: 'Melina Uliarte', title: [t('equipo.titulos.periodista'), t('equipo.titulos.locutora')], role: t('equipo.puesto.project'), img: 'melina_uliarte.jpg', instagram: 'https://www.instagram.com/meliuliarte?igsh=MWYzOG91bWpwNnY5Yg==' },
